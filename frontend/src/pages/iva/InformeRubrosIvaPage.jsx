...
export default function InformeRubrosIvaPage() {
  ...
  async function buscar() {
    ...
    setLoading(true);
    try {
      const res = await api.getRubrosIva({ modulo, empresa: empresa.id, periodo });
      setFilas(res.data.resultado);
    } catch {
      toast.current.show({ severity: 'error', summary: 'Error', detail: 'No se pudo obtener el Informe de Rubros' });
    } finally {
      setLoading(false);
    }
  }
  ...
  return (
    <div className="page-iva">
      ...
      <div className="page-header-row">
        <BotonVolver />
        <h2 className="page-title"><i className="fa-solid fa-tags" /> Informe de Rubros</h2>
      </div>
      ...
      >
        <Column field="rubro_descripcion" header="Rubro" />
