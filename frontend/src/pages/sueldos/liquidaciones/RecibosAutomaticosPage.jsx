    ...
    <div className="page-liquidaciones">
      ...
      <div className="filtros-toolbar">
        <div className="form-field">
          ...
          <Dropdown value={periodo} options={periodoOptions} onChange={e => setPeriodo(e.value)} filter placeholder="Seleccionar período" style={{ width: '280px' }} panelClassName="liquidaciones-dropdown-panel" />
        </div>
        <div className="form-field">
          <label>Legajo</label>
