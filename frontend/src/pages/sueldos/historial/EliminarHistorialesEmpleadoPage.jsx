...
export default function EliminarHistorialesEmpleadoPage() {
  ...
  async function buscar() {
    setLoading(true);
    try {
      const res = await api.getHistorialesEmpleadoList({ ...filtro, fechaDesde: toIsoDate(fechaDesde), empresa: empresa?.id });
  ...
  function handleEliminar() {
    ...
    confirmDialog({
      ...
      accept: async () => {
        setEliminando(true);
        try {
          await api.deleteHistorialesEmpleadoMasivo({ ...filtro, fechaDesde: toIsoDate(fechaDesde), empresa: empresa?.id });
