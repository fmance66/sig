...
export default function InformeProvinciasIvaPage() {
  ...
  async function buscar() {
    ...
    setLoading(true);
    try {
      const res = await api.getProvinciasIva({ modulo, empresa: empresa.id, periodo });
      setFilas(res.data.resultado);
    } catch {
      toast.current.show({ severity: 'error', summary: 'Error', detail: 'No se pudo obtener el Informe de Provincias' });
    } finally {
      setLoading(false);
    }
  }
  ...
  return (
    <div className="page-iva">
      ...
      <div className="page-header-row">
        <BotonVolver />
        <h2 className="page-title"><i className="fa-solid fa-map-location-dot" /> Informe de Provincias</h2>
      </div>
